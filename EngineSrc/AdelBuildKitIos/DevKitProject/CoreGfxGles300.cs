...
namespace AdelBuildKitIos
{
    //------------------------------------------------------------------------------
    /// <summary>
    /// OpenGLES 3.0 実装の CoreGfx。
    /// </summary>
    class CoreGfxGles300 : CoreGfxAddonBase
    {        
        //------------------------------------------------------------------------------
        /// <summary>
        /// Name の static 版。
        /// </summary>
        public static string StaticName { get { return nameof(AdelBuildKitIos) + "." + nameof(CoreGfxGles300); } }
        ...
        public override NativeCodeBuildInfo CreateNativeCodeBulidInfo(CreateNativeCodeBuildInfoArg aArg)
        {
            var obj = new NativeCodeBuildInfo();
            {
                ...
                dirs.Add(new DirectoryInfo(mainDirRoot.FullName + "/ae_ios_gles300"));
