...
const Matrix44Pod Matrix44Pod::Mul(const Matrix44Pod& rHS)const
{
    ...
    mtx.v[Index20] =
        ...
        + this->v[Index23] * rHS.v[Index30];
    mtx.v[Index21] =
        this->v[Index20] * rHS.v[Index01]
        + this->v[Index21] * rHS.v[Index11]
        + this->v[Index22] * rHS.v[Index21]
        + this->v[Index23] * rHS.v[Index31];
    mtx.v[Index22] =
        this->v[Index20] * rHS.v[Index02]
        + this->v[Index21] * rHS.v[Index12]
        + this->v[Index22] * rHS.v[Index22]
        + this->v[Index23] * rHS.v[Index32];
    mtx.v[Index23] =
        this->v[Index20] * rHS.v[Index03]
        + this->v[Index21] * rHS.v[Index13]
        + this->v[Index22] * rHS.v[Index23]
        + this->v[Index23] * rHS.v[Index33];

    // c3
    mtx.v[Index30] =
        this->v[Index30] * rHS.v[Index00]
        + this->v[Index31] * rHS.v[Index10]
        + this->v[Index32] * rHS.v[Index20]
        + this->v[Index33] * rHS.v[Index30];
    mtx.v[Index31] =
        this->v[Index30] * rHS.v[Index01]
        + this->v[Index31] * rHS.v[Index11]
        + this->v[Index32] * rHS.v[Index21]
        + this->v[Index33] * rHS.v[Index31];
    mtx.v[Index32] =
        this->v[Index30] * rHS.v[Index02]
        + this->v[Index31] * rHS.v[Index12]
        + this->v[Index32] * rHS.v[Index22]
        + this->v[Index33] * rHS.v[Index32];
    mtx.v[Index33] =
        this->v[Index30] * rHS.v[Index03]
        + this->v[Index31] * rHS.v[Index13]
        + this->v[Index32] * rHS.v[Index23]
        + this->v[Index33] * rHS.v[Index33];
...
Matrix44::Matrix44(
    ...
    const f32 r3C0, const f32 r3C1, const f32 r3C2, const f32 r3C3
    )
{
    v[Index00] = r0C0;
    v[Index10] = r1C0;
