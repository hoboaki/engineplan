...
//------------------------------------------------------------------------------
DrawIndirectNormalCommand& DrawIndirectNormalCommand::SetVertexOffset(const int offset) {
...
//------------------------------------------------------------------------------
DrawIndirectNormalCommand& DrawIndirectNormalCommand::SetInstanceOffset(const int offset) {
    AE_BASE_ASSERT_LESS_EQUALS(0, offset);
